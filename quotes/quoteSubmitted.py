...
data_file = open(("quotes/pending/" + quote_id + ".json"), "x")
data_file.write(json.dumps(input_variable))

page_file = open(("quotes/pending/" + quote_id + ".php"), "x")
...
page_file.write("<form action=\"../quoteDisapproved.php\" method=\"post\">")
page_file.write("<input id=\"quoteId\" name=\"quoteId\" value=\"" + quote_id + "\" />")
page_file.write("<input type=\"submit\" value=\"Disapprove\" />")
page_file.write("</form>")
