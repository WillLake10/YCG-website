...
for (var i = 0; i < quotes.length; i++) {
    document.write('<div class="row pt-3 ">');
    document.write('<div class="col-12">');
    for (var j = 0; j < quotes[i].length; j++){
        if(quotes[i][j][0] === ''){
            document.write('<p><span class="quotesExtra">"' + quotes[i][j][1] + '"</span></p>');

        }else{
            document.write('<p><span class="quotesName">' + quotes[i][j][0] + ': </span>');
            document.write('<span class="quotesBody">"' + quotes[i][j][1] + '"</span></p>');
        }
    }
    document.write('</div>');
    document.write('</div>');
    if(i !== quotes.length-1){
        document.write('<script src="scripts/splitterCont.js" type="text/javascript"></script>');
    }
...
function getQuotes() {
    return [
        [['Tom', 'Are you brown?']],
        [['Rosie', 'It\'s got drugs and sex things'], ['Claire', 'That\'s more my thing!']],
        [['Rosie', 'Don\'t squeeze my quiche']],
        [['Will', 'Rosie was trying to explain bell anatomy']],
        [['Billy', 'I had a platonic interaction with Lucy']],
        [['Billy', 'We\'ll do it double blow'], ['Lucy', 'That sounds dodgy']],
        [['Zoe', 'That should be our society motto: blame Will but in latin']],
        [['Rosie', 'Tinder for quarters!!!']],
        [['Caroline', 'F**k NUSCR']],
        [['Caroline', 'Will\'s got a massive hard on for St Lawrence\'s handbells']],
        [['Unknown at Fresher\'s Fayre 2019', 'Ringers ring my bells']],
        [['Caroline', 'I\'m chopping apples and I don\'t know why']],
        [['David D', 'Mine was smashing with Kevin\'s']],
        [['Caroline', 'I did not have sexual relations with that hamster']],
        [['Eric', 'Huw\'s single, you can do it with him']],
        [['Huw', 'PDA: Public Domestic Abuse']],
        [['Rosie', 'I can\'t be in a relationship as I\'m in a committed relationship with ringing']],
        [['Rosie', '... tied bell sessions'], ['Caroline', 'Like tide pods?']],
        [['Georgie', 'I want a big knife']],
        [['Rosie', 'I\'d love to be a tractor genuinely']],
        [['Caroline', 'You can call it a dong-ument']],
        [['Rosie', 'It\'s not a party it\'s just an intimate get together'], ['Caroline', 'Sounds like an orgy']],
        [['Caroline', 'A neutral coloured rainbow']],
        [['Caroline', 'I peed on a goose']],
        [['Lily', 'Dib-dab']],
        [['Simon', 'No one has figured out where uranus should be']],
        [['Will', 'Were you there when Simon was doing Caroline earlier?']],
        [['Billy', 'Give me the finger when you want me to start doing it']],
        [['Will', 'I just noticed Caroline moved onto Simon\'s lap'], ['Caroline', 'It was better positioning!']],
        [['Eric', 'Stop doing it at that angle! It\'s kind of inappropriate']],
        [['Will', '1 o\'clock (PM) is morning!']],
        [['Caroline', 'I want someone to love me as much as Georgie loves spoons']],
        [['Will', 'They\'re a bit floppy to do that']],
        [['Rosie (to Simon)', 'Do you have a D']],
        [['Rosie (about sleeping around collages)', 'Does hes east count as it\'s dead, surely that\'s necrophillia!']],
        [['Caroline (to Will)', 'Stop flashing!']],
        [['Billy (to room full of ringers)', 'Are there any ringers here?']],
        [['Zoe', 'My badgers a boy!']],
        [['Will', 'It was very wet but good fun']],
        [['Millie (on covering)', 'Doing a bongy boi']],
        [['Will', 'Talking about astronomy, Uranus has been stolen!']],
        [['Georgie', 'I think racist horses would be better than most of the crap on TV']],
        [['Will', 'Yes I did the sex show!']],
        [['Millie', 'I had a thing for Barry Chuckle ok don\'t attack me!']],
        [['Caroline', 'I\'m not moving I don\'t give a shit about Will\'s happiness']],
        [['Simon', 'I\'m going to go for sex with animals']],
        ...
        [['Billy', 'Intercourse?'], ['Caitlin', 'no, Interpol']],
        ...
        [['Holly', 'I\'ve only got short legs.'], ['Billy', 'Spread \'em']],
        ...
        [['Claire', 'Billy, where are you going?'], ['Billy', 'I don\'t know but I just feel like a bit of parkour.']],
        ...
        [['Lucy (to Eric)', 'Come on! Get it up!'], ['Kevin', 'Now spread \'em']],
        ...
        [['Charlotte', 'I assume she\'s on birth control...'], ['Ben', 'She\'s from Sheffield.']],
        ...
        [['Claire R', 'Did I eat my penny?!']],
        [['Claire, Claire and Lucy (in unison)', 'Tights up, skirt down!'], ['Ryan', 'Surely that should be the other way around...']],
        [['Nathan (to Lucy)', 'I\'ll do it with you. I\'ll keep you going!']],
        [['Ryan', 'The last girl I tried to do that to tried to bite me...']],
        [['Claire R (to Ryan)', 'You wouldn\'t let me shut my mouth!']],
        [['Eric', 'You didn\'t try to force me into a position. Should I be offended?']],
        [['Claire R', 'For goodness sake, my genitals really worked for that one!']],
        [['Lucy', 'The swift retraction of your legs gave quite an interesting sensation']],
        [['Lucy (to Ryan)', 'You\'re really hard.']],
        [['Lucy', 'Let\'s take the coats off and we can do it properly.']],
        [['Lucy', 'It was longer than I expected and going everywhere!']],
        [['Nathan', 'It doesn\'t seem to want to go down']],
        [['Clare R (to Nathan)', 'Would you like me to put it in?'], ['', '... I was just being polite!']],
        [['Lydia', 'You can come to my house and drag me to the church, but you will not make me ring!']],
        [['Lydia', 'You\'re going to strap me to a chair?!']],
        [['Lucy W', 'We could have an NUA take 2, and all sleep together!']],
        [['Ryan (to Claire R)', 'How tall do you like them?']],
        [['Lilah (regarding Nathan)', 'My nose went up his crack! ... through the sleeping bag!']],
        [['Claire R', 'Are you ticklish?'], ['Jac', 'Yes, but you have to do it in the right way.']],
        [['Claire R', 'It hurts to suck it!']],
        [['Charlotte A', 'I will never learn place bells. I would rather die.']],
        [['Iain', 'There\'s an article I could read. But it was written in 1873 and talks about fairies so I\'m not sure how accurate it is.']],
        [['Kevin (observing the carrying of coal up a mountain)', 'It must have been quite hard for those hobbits.'], ['Iain', 'They weren\'t carrying coal, they were carrying a ring... [pause] ...I wish we were carrying a ring.']],
        [['Iain', 'Is that water at an angle or what?']],
        [['Kevin', 'Oh Ryan, did you really think putting the eggs on the dashboard was a good idea?']],
        [['Kevin (concerning his socks)', 'Mmm, potato fresh']],
        [['Ryan', 'I\'ve been busy, I haven\'t had time for hygiene in the last three weeks']],
        [['Eric', 'The key is to avoid the spinal cord']],
        [['Kevin (to Char)', 'You lie in the grass and I\'ll dive on you']],
        [['Ryan', 'I am good at teamwork as long as everyone does what I say']],
        [['Matt G (on introducing his girlfriend)', 'She is incredibly competent in many areas, but surprise royal is not one of them']],
        [['Becky (to Eric)', 'When a Latin dictionary is your comfort blanket, you know you have a problem']],
        [['Kevin', 'This would be far more interesting if we were all tied together']],
        [['Kevin', 'I don\'t understand bellringing']],
        [['Charlotte', 'Are we seriously rolling backwards?!'], ['', 'Oh wait, I\'m in reverse.']],
        [['Becky (Gesturing wildly)', 'All rumours come from me!']],
        [['Ryan', 'Do you get the postman up your way?'], ['Becky', 'Yes, but he only comes twice a week'], ['Kevin', 'But he delivers the mail every day']],
        [['Eric (to Anna-Lena)', 'I should stop playing with your thing']],
        [['Joost', 'I can\'t, I actually have to watch a football match for my course']],
        [['Ryan', 'You should watch a really rough and dirty one']],
        [['Joost', 'Stedman: It\'s just a lot of fucking around at the back']],
        [['Ryan', 'I think I will probably end up doing it']],
        [['Becky', 'You didn\'t teach me to ring, but you taught me to ring well']],
        [['Becky (to Alex)', 'Can we not watch people having sex on my bed please.']],
        [['Ryan', 'Isn\'t it great when the men dress up as women']],
        [['Ryan (concerning Polos)', 'It\'s hard; you\'re meant to suck it.']],
        [['Ryan (to most of coach C standard class, RE his encounter with Sara in the, now infamous, disabled toilet of Stretford church hall)', 'I remember entering, but not leaving. Though, I\'m sure I did.']],
        [['Sara', 'What\'s brown and sounds like a bell?'], ['', 'Dunggggg']],
        [['Ryan', 'Mine\'s quite big, but his is bigger']],
        [['Helen B', 'Are you interested in bellringing?'], ['Random Person', 'What? Like doorbells?']],
        [['Tim', 'Handel is like musical sex.']],
        [['Char', 'To the Bat Cave!']],
        ...
        [['James Ramsbottom (to Tom Luxford)', 'How do you get the Willy out?'], ['', '...Silence...'], ['Lilah', 'What are you talking about?!'], ['James', 'Handbells'], ['Adam Crocker ', 'Ooooh is that a long length then?!!']],
        ...
        [['Kevin', 'How do you get chlamydia in your eye?'], ['Jenni', 'How do you think you get chlamydia in your eye?'], ['All', '...Eyww.']],
        ...
        [['Lottie', 'So you\'re a girl now?'], ['Matthew I', 'Yes!']],
        [['Matthew G', 'I did Lilah at the NUA']],
        [['Matthew G (shocked)', 'Are you eating a salad, James?']],
        [['Sam', 'This is O.K. to bash your head against, it\'s pretty soft.'], ['Lottie (rapping her knuckles on the wall, hard)', 'Ow! No it\'s not!']],
        [['Lilah', 'Gillete for men, vibrating razor. that sounded exciting, so I bought one!']],
        [['Lilah', 'Will you sing with me, Sam?'], ['Sam (meekly)', 'It\'s early, and you\'ve fed me Pringles and no water...']],
        ...
        [['Sophie', 'Stop groping me!'], ['Kevin', 'I was helping... If I was groping you it would feel like this.']],
        ...
        [['Lottie', 'I can\'t breathe'], ['Sam', 'I can give you something to inhale on.']],
        ...
        [['Lilah', 'Why\'s my bag all open?'], ['Karen', 'Because I\'ve been rifling through it.']],
        ...
        [['Lilah', 'Arthur\'s not very camp.'], ['Matt G', 'He was when he was with me.']],
        ...
        [['Kevin', 'Does it have sex in it?'], ['Emma', 'No.'], ['Kevin (disappointedly)', 'Oh. Ok then.']],
        [['Emma', 'I\'m sorry, I\'ll stop stroking you.']],
        [['Matthew', 'What\'re you doing, Lilah?'], ['Lilah', 'I\'m just playing with my toy.']],
        ...
        [['MJJ', 'I\'ve never been barred from anywhere.'], ['Char', 'Sorry, you\'re trying to attract David Denbigh?']],
        [['James (to Jeni)', 'We didn\'t do anything with the banana last night.']],
        [['Kevin (to Char)', 'What\'s my speech impediment?'], ['Char', 'You open your mouth and a load of rubbish comes out.']],
        [['David P', 'Do you want a job Charlotte? Sharpening my pencil?'], ['Char', 'Yes. I\'ve already done that.']],
        [['Jeni', 'I use the bum for everything...']],
        [['MJJ (to Nicola)', 'Do you have stretch marks?']],
        [['Rob', 'Are they truffles?'], ['MJJ', 'Yes, they\'re truffles. Well, I think they\'re truffles. Actually, what are truffles?']],
        ...
        [['Kevin (to Rob, discussing the merits of Lincolnshire S Max)', 'Is it pants then?'], ['Rob (to Kevin)', 'Er, it\'s not pants, but it\'s not exactly lingerie.']],
        ...
        [['Matthew', 'I can be sexy in my dreams'], ['Matt G', 'You can be sexy in Arthur\'s dreams as well']],
        [['Arthur', 'You\'d better dance with me at dinner day'], ['Matt G', 'No, I\'m going to dance with Kevin and make you jealous']],
        ...
        [['Jeni', 'How can I fit all that in my mouth?'], ['David D', 'Just open wide and think of me.']],
        [['Rob (re David P)', 'You don\'t want to end up underneath him...']],
        ...
        [['Nicki C (to Matt G)', 'No don\'t take it out, don\'t take it out!'], ['Kevin (to Nicki C)', 'Do you shout that in moments of passion?']],
        ...
        [['Kevin', 'That was quite exhilarating!'], ['Matthew J', 'Do you want to get down and do it again?']],
        ...
        [['Matthew Jones', 'Am I in there?'], ['Guy', 'Look under W...']],
        [['Karen Owen', 'Don\'t stick my gecko in your ear.']],
        [['Karen Owen', 'Stop fiddling with my knobs.']],
        [['Matthew Jones', 'Where have you been?'], ['Arthur', 'Toilet'], ['Matthew Jones', 'Were you intercepted there?']],
        ...
        [['Matt G (to Matthew J)', 'Face it Matthew, you just can\'t keep it up'], ['Matthew J', 'Watch out, Matthew, or else I\'ll practice my bayonet drill on you.']],
        [['Arthur (to Matthew Jones)', 'Every time you open your mouth...'], ['', 'No Matthew, don\'t put it in...'], ['', 'Why are you putting it in?']],
        ...
        [['David (to Arthur) (whilst attempting to ring down in peal)', 'Arthur, what the fuck are you doing?']],
